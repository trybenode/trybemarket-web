...
// A conversation marked saleStatus "pending" that neither side confirms nor
// disputes resets back to "none" after this long (03-sale-confirmation.md
// §6) — no credit implication either way (nothing is ever awarded on a
// single-sided confirmation), purely so the "confirm sale?" prompt doesn't
// sit there forever. See lib/saleConfirmationServer.js's expirePendingSale.
export const SALE_PENDING_TIMEOUT_MS = 24 * 60 * 60 * 1000; // 24 hours
