 ...
 */
export async function recomputeRankForItem(itemType, itemId) {
  ...
  await ref.update({ sellerTier, rankScore, searchKeywords });
  return { sellerTier, rankScore, searchKeywords };
}
