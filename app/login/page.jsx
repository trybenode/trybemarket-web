...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      router.push(isFirstTimeUser ? "/select-university" : "/");
    } catch (error) {
...
//   // Initialize user store and check for authenticated user
//   useEffect(() => {
//     const unsubscribe = auth.onAuthStateChanged(async (user) => {
//       if (user) {
//         await useUserStore.getState().loadUser();
//         const { user: storeUser, isInitialized } = useUserStore.getState();
//         if (isInitialized && storeUser) {
//           const university = localStorage.getItem("university");
//           if (university) {
//             router.replace("/"); // Redirect to home if university is set
//           } else {
//             router.replace("/select-university"); // Redirect to university selection if missing
//           }
//         }
//       } else {
//         useUserStore.getState().loadUser();
...
//         id: user.uid,
//         email: user.email,
//         university: localStorage.getItem("university") || null,
//       });

//       const university = localStorage.getItem("university");
//       const redirectPath = university ? "/" : "/select-university";
...
//       toast.success(`Login Successful: Welcome ${user.displayName || "User"}`, {
//         position: "top-center",
//         duration: 3000,
//       });
